...
def fit_one_epoch(net,criterion,epoch,epoch_size,epoch_size_val,gen,genval,Epoch,cuda):
    ...
    if epoch%9 == 0:
        torch.save(model.state_dict(), '/mnt/disk/zhh/ssd-pytorch-master/logs/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth'%((epoch+1),total_loss/(epoch_size+1),val_loss/(epoch_size_val+1)))
...
if __name__ == "__main__":
    ...
    #   权值文件请看README，百度网盘下载
    #------------------------------------------------------#
    model_path = "/mnt/disk/zhh/ssd-pytorch-master/model_data/ssd_weights.pth"
    ...
    annotation_path = '/mnt/disk/zhh/ssd-pytorch-master/2007_train.txt'
    #----------------------------------------------------------------------#
